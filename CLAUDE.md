...
This repo is the **aggregator plugin** for Make Good's Claude Code skills. It bundles all 21 per-skill repos into a single installable plugin so users can run `/plugin install makegood-skills@makegood-skills` and get everything at once.
