...
A Claude Code skill that audits existing Agent Skills against current best practices and suggests improvements.
...
1. Download the latest `auditing-skills-<version>.zip` from the [Releases page](https://github.com/WeMakeGood/auditing-skills/releases).
2. Unzip it into your Claude Code skills directory:
   ```
   unzip auditing-skills-<version>.zip -d ~/.claude/skills/
   ```
...
```
git clone https://github.com/WeMakeGood/auditing-skills.git ~/.claude/skills/auditing-skills
```
