...
See [references/ARCHITECTURE.md](references/ARCHITECTURE.md) for the full module design philosophy, runtime perspective, single source of truth and use-shapes, shape reference (G1 as worked example), content transformation rules, and token management.
